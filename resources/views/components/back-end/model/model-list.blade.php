            ...
            <div class="card-body">
              ...
              <div class="table-wrapper">
                <table id="printTable" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <tr data-row="1" data-date="2024-08-05">
                      <td>121</td>
                      <td>INV#01</td>
                      <td>VRISTA: UI/UX Design</td>
                      <td>
                        <div class="client-item">
                          <div class="image">
                            <img
                              src="{{asset('back-end/assets/img/table-client-img.png')}}"
                              alt="client"
                    ...
                    <tr data-row="2" data-date="2024-08-04">
                      <td>122</td>
                      <td>INV#02</td>
                      <td>ELLA BLOGER: UI Design & Development</td>
                      <td>
                        <div class="client-item">
                          <div class="image">
                            <img
                    ...
                    <tr data-row="3" data-date="2024-08-01">
                      <td>123</td>
                      <td>INV#03</td>
                      <td>ELLA BLOGER: UI Design & Development</td>
                      <td>
                    ...
                    <tr data-row="1" data-date="2024-08-10">
                      <td>121</td>
                      <td>INV#01</td>
                      <td>VRISTA: UI/UX Design</td>
                      <td>
                    ...
                    <tr data-row="4" data-date="2024-08-03">
                      <td>123</td>
                      <td>INV#04</td>
                    ...
                    <tr data-row="5" data-date="2024-08-02">
                      <td>123</td>
                      <td>INV#05</td>
                      <td>VRISTA: UI/UX Design</td>
                      <td>
                    ...
                    <tr data-row="5" data-date="2024-08-02">
                      ...
                      <td>
                        <div class="client-item">
                          <div class="image">
                            <img
                              src="./assets/img/table-client-img.png"
                              alt="client"
                              class="rounded-circle mr-2"
                              width="30"
                            />
